defmodule Chirpp.Timeline do
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Chirpp.PubSub, "posts")
  end

  defp broadcast({:error, _reason} = error, _event), do: error

  defp broadcast({:ok, post}, event) do
    Phoenix.PubSub.broadcast(Chirpp.PubSub, "posts", {event, post})
    {:ok, post}
  end
end
